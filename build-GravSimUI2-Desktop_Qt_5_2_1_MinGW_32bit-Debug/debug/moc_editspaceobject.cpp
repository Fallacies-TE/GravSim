...
struct qt_meta_stringdata_EditSpaceObject_t {
    QByteArrayData data[3];
    char stringdata[40];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_EditSpaceObject_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_EditSpaceObject_t qt_meta_stringdata_EditSpaceObject = {
    {
QT_MOC_LITERAL(0, 0, 15),
QT_MOC_LITERAL(1, 16, 21),
QT_MOC_LITERAL(2, 38, 0)
    },
    "EditSpaceObject\0on_pushButton_clicked\0"
    "\0"
};
...
const QMetaObject EditSpaceObject::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_EditSpaceObject.data,
      qt_meta_data_EditSpaceObject,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EditSpaceObject.stringdata))
