...
struct qt_meta_stringdata_DeleteSpaceObject_t {
    QByteArrayData data[3];
    char stringdata[42];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_DeleteSpaceObject_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_DeleteSpaceObject_t qt_meta_stringdata_DeleteSpaceObject = {
    {
QT_MOC_LITERAL(0, 0, 17),
QT_MOC_LITERAL(1, 18, 21),
QT_MOC_LITERAL(2, 40, 0)
    },
    "DeleteSpaceObject\0on_pushButton_clicked\0"
    "\0"
};
...
const QMetaObject DeleteSpaceObject::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DeleteSpaceObject.data,
      qt_meta_data_DeleteSpaceObject,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DeleteSpaceObject.stringdata))
